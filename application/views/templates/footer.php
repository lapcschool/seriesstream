	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-7 col-sm-12 footer-widget">
				...
				<div class="img-gallery">
					<div class="img-container">
						...
						<a class="thumb-holder" data-rel="prettyPhoto" href="<?php echo base_url(); ?>assets/images/gallery/2.jpg">
							<img src="<?php echo base_url(); ?>assets/images/gallery/2.jpg" alt="">
						</a>
						<a class="thumb-holder" data-rel="prettyPhoto" href="<?php echo base_url(); ?>assets/images/gallery/3.jpg">
							<img src="<?php echo base_url(); ?>assets/images/gallery/3.jpg" alt="">
						</a>
						<a class="thumb-holder" data-rel="prettyPhoto" href="<?php echo base_url(); ?>assets/images/gallery/4.jpg">
			...
			<div class="col-md-4 col-sm-12 footer-widget footer-about-us">
				<h3 class="widget-title">Sobre la institución que pertenecemos</h3>
				<h4>ITLA</h4>
				<p>Institución técnica de educación superior, especializada en la capacitación técnica-profesional e inglés como segunda lengua; en áreas de alta tecnología y bajo un modelo de “technical college”.</p>
				<h4>Dirección</h4>
